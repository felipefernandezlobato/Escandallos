...
export const FROZEN_TUBES: FrozenTube[] = [
  ...
  { name: "BD Tennessee (90+)", costPerKgEur: 91.00, supplement: 0 },
  { name: "BD Meltic (89)", costPerKgEur: 89.10, supplement: 0 },
  { name: "DABOV COE Ethiopia", costPerKgEur: 69.46, supplement: 8 },
  { name: "DABOV Ethiopia Alo Mosto", costPerKgEur: 57.12, supplement: 6 },
  { name: "BD Lalo (88)", costPerKgEur: 56.60, supplement: 0 },
  { name: "DABOV Panama Lerida", costPerKgEur: 52.64, supplement: 5 },
  { name: "BD Lazo Bloom (88)", costPerKgEur: 49.90, supplement: 0 },
  { name: "BD Lord (87)", costPerKgEur: 49.40, supplement: 0 },
